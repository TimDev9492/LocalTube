                        ...
                        <div className=" flex items-center">
                            ...
                            <div className="hidden md:block">
                                <div className="ml-10 flex items-baseline space-x-4">
                                    <div onClick={() => setPageContent(new PageContentData(Tab.Home, null))} className="group cursor-pointer flex items-center text-slate-300  hover:text-slate-800 dark:hover:text-white px-3 py-2 rounded-md text-md font-medium">
