...
export default function PageContent({ database, pullDatabase, contentData }: { database: LocalTubeDatabase, pullDatabase: Function, contentData: PageContentData }): JSX.Element {
    ...
    return <div className="dark:bg-slate-700 flex items-center justify-center flex-1 p-16">
        ...
        {contentData.getTab() === Tab.Home && <Overview shows={data as LocalShow[]} pullDatabase={pullDatabase} />}
    </div>
}